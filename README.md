...
| Day 8 | K-Nearest Neighbors | 标准化 Pipeline、K 值验证集选择与最终测试 |
| Day 9 | Decision Tree | 树深度分析、特征重要性与最终测试 |
| Day 10 | Random Forest | 集成模型参数分析、特征重要性与最终测试 |
| Day 11 | Support Vector Machine | 标准化 SVM、核函数与参数分析 |
| Day 12 | Cross-validation 与 GridSearchCV | 训练集内分层交叉验证、SVM 网格搜索与最终测试 |
| Day 13 | 公平多模型比较 | 相同 CV 折上的 Dummy、线性、距离、树和 SVM 比较 |
| Day 14 | AI4I 项目升级、复习与验收 | 无泄漏模型选择、调参、阈值选择、错误分析与可加载推理 |
...
| 整体路线 | 主题 | 脚本 |
| --- | --- | --- |
| Day 08 | K-Nearest Neighbors | `src/day08_knn.py` |
| Day 09 | Decision Tree | `src/day09_decision_tree.py` |
| Day 10 | Random Forest | `src/day10_random_forest.py` |
| Day 11 | Support Vector Machine | `src/day11_svm.py` |
| Day 12 | Cross-validation 与 GridSearchCV | `src/day12_cross_validation.py` |
| Day 13 | 公平多模型比较 | `src/day13_model_comparison.py` |
| Day 14 | AI4I 项目升级、复习与验收 | `projects/iot_failure_prediction/` |
